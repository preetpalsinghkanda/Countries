...
const Hero = () => {
  ...
  return (
    <div className=" px-20 flex bg-[#fcfcfc] justify-between py-10">
      ...
      <div className="w-52 ">
        <Listbox value={selected} onChange={setSelected}>
          <div className="relative">
            <Listbox.Button className="shadow-[0_1px_8px_rgba(0,0,0,0.10)] flex w-full justify-between items-center outline-0 rounded-md  gap-8 px-4 py-3">
            ...
            <Listbox.Options className="absolute w-full shadow-[0_1px_8px_rgba(0,0,0,0.10)] bg-white outline-hidden mt-2 px-4 rounded-md  py-3">
              {regions.map((region) => (
                <Listbox.Option className="cursor-pointer whitespace-nowrap" key={region} value={region}>
                  {region}
